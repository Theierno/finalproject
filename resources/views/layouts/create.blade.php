...
@section('contenu')
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        @if (session()->has('success'))
            ...
            @endif
        <form style="width:65%;" method="post" action="{{ route('register') }}" >
        @csrf
        <div class="mb-3">
            <label for="matricule" class="form-label">Matricule de l'employe</label>
            <input type="number" class="form-control" id="matricule" name="matricule_de_solde">
            </div>
            <div class="mb-3">
            <label for="nom" class="form-label">Nom complet de l'employe</label>
           ...
           <select name="role" class="form-control" id="class">
                ...
                <option value="RH">DAGE</option>
                <option value="RH">Employe simple</option>
           </select>
            </div>                 
